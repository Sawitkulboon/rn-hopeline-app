...
export default function Login() {
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.text}>Create to your Account</Text>
            <TextInput placeholder="Email" style={styles.input}></TextInput>
            <TextInput placeholder="Password" style={styles.input2}></TextInput>
            <TextInput placeholder="Confirm Password" style={styles.input2}></TextInput>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 50, justifyContent: 'center' }}>
                ...
                <TouchableOpacity onPress={() => router.push("/input")}>
                    <Text style={{ color: '#390050', fontWeight: 'bold' }}>Sing In</Text>
                </TouchableOpacity>
            </View>
        </View>
    )
